...
if TYPE_CHECKING:
    ...
    from ..models.unets.unet_3d_condition import UNet3DConditionModel
...
def _maybe_expand_lora_scales(unet: "UNet3DConditionModel", weight_scales: List[Union[float, Dict]]):
