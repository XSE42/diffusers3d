...
class JointAttnProcessor2_0:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        elif context_input_ndim == 5:
            batch_size, channel, depth, height, width = encoder_hidden_states.shape
            encoder_hidden_states = encoder_hidden_states.view(batch_size, channel, depth * height * width).transpose(1, 2)
        ...
        if context_input_ndim == 4:
            ...
            encoder_hidden_states = encoder_hidden_states.transpose(-1, -2).reshape(batch_size, channel, depth, height, width)
